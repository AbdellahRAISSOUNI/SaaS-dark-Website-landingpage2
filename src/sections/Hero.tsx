...
export const Hero = () => {
  ...
  return (
    <motion.section
    ref={sectionRef}
      className="h-[492px] ms:h-[800px] flex items-center overflow-hidden relative [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)]"
      style={{
