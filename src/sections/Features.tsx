...
const FeatureTab = (
  ...
  return (
    <div
      ...
      aria-label={`Select ${props.title} tab`}
    >
      {props.selected && (
        <motion.div
          style={{
          ...
          className="absolute inset-0 -m-px border-[#A369FF] rounded-xl"
        ></motion.div>
      )}
  ...
  return (
    <section className="py-20 md:py-24">
      <div className="container">
        ...
        <div className="border border-white/20 p-2.5 rounded-xl m-3">
          <motion.div
